...
const base = (claims) => ({ manifest: { version: '2.0.0', site: 'https://example.com' }, claims });
...
w('missing-required.json', { manifest: { version: '2.0.0', site: 'https://example.com' }, claims: [{ id: 'x', type: 'capability' }] });
...
w('no-claims.json', { manifest: { version: '2.0.0', site: 'https://example.com' }, claims: [] });
...
w('unicode.json', { manifest: { version: '2.0.0', site: 'https://example.com', language: 'fr' },
...
w('self-referential.json', { manifest: { version: '2.0.0', site: 'https://example.com' },
